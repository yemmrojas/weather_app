...
class WeatherRepositoryImpl @Inject constructor(
    ...
    private val weatherForecastMapper: Converter<WeatherForecastResponseDto, WeatherForecast>
) : WeatherRepository {
    ...
    override fun getWeatherForecast(location: String): Flow<Result<WeatherForecast>> = flow {
        try {
            ...
            val weatherForecast = weatherForecastMapper.convert(response)
